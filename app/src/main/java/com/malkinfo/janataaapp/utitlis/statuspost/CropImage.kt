 ...
 * ------------------------------------------
 */
class CropImage @JvmOverloads constructor(
...
//    please see the View lifecycle for more details
    ...
    fun getBitmapImage(isImgBitmap:Bitmap){
        src = isImgBitmap
        invalidate()
    }
    ...
    // pass bitmap image
    private var src: Bitmap = BitmapFactory.decodeResource(resources, R.drawable.profile_iv)
    ...
    // dark overlay rect
    private val foregroundArcColor = context.resources?.getColor(R.color.semi_black_transparent, null) ?: Color.GRAY
